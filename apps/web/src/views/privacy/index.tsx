				...
				<div className="mb-20 flex h-full w-full max-w-[800px] flex-col lg:pt-[5rem]">
					...
					<div className="mb-6">
						...
						<Text>
							...
							respect your privacy and comply with any applicable
							law and regulation regarding any personal
							information we may collect about you, including
							across our website, {NAME}, and other sites we own
							and operate.
						</Text>
					</div>
					...
					<div className="mb-6">
						...
						<Text>
							...
							knowingly and actively provide us when using or
							participating in any of our services and promotions,
							and any information automatically sent by your
							devices in the course of accessing our products and
							services.
						</Text>
					</div>
					...
					<div className="mb-6">
						...
						<Text>
							...
							web browser. It may include your device’s Internet
							Protocol (IP) address, your browser type and
							version, the pages you visit, the time and date of
							your visit, the time spent on each page, other
							details about your visit, and technical details that
							occur in conjunction with any errors you may
							encounter.
						</Text>
						<Text>
					...
					<div className="mb-6">
						...
						<Text>
							We may ask for personal information which may
					...
					<div className="mb-6">
						...
						<UnorderedList>
							<ListItem>
								Sign up to receive updates from us via email or
								social media channels
							</ListItem>
							<ListItem>
								Use a mobile device or web browser to access our
								content
							</ListItem>
							<ListItem>
						...
						<UnorderedList>
							...
							<ListItem>
								...
								associated applications, and associated social
								media platforms
							</ListItem>
						</UnorderedList>
						<Text>
							Please be aware that we may combine information we
							collect about you with general information or
					...
					<div className="mb-6">
						...
						<Text>
							...
							security. We will comply with laws applicable to us
					...
					<div className="mb-6">
						...
						<Text>
							...
							with this privacy policy. If your personal
							information is no longer required, we will delete it
						...
						<Text>
							...
							information for our compliance with a legal,
							accounting, or reporting obligation or for archiving
					...
					<div className="mb-6">
						...
						<Text>
							We do not aim any of our products or services
							directly at children under the age of 13, and we do
							not knowingly collect personal information about
							children under 13.
						</Text>
					</div>
					...
					<div className="mb-6">
						...
						<UnorderedList>
							...
							<ListItem>
								...
								enabling them to provide their services, for
								example, IT service providers, data storage,
								hosting and server providers, advertisers, or
								analytics platforms
							</ListItem>
							<ListItem>
							...
							<ListItem>
								...
								sweepstakes, or promotion we run
							</ListItem>
							<ListItem>
								courts, tribunals, regulatory authorities, and
								law enforcement officers, as required by law, in
								connection with any actual or prospective legal
								proceedings, or in order to establish, exercise,
								or defend our legal rights
							</ListItem>
							<ListItem>
								third parties, including agents or
								sub-contractors, who assist us in providing
								information, products, services, or direct
								marketing to you third parties to collect and
								process data
							</ListItem>
						</UnorderedList>
					</div>
					...
					<div className="mb-6">
						...
						<Text>
							...
							processed where we or our partners, affiliates, and
							third-party providers maintain facilities. Please be
							aware that the locations to which we store, process,
							or transfer your personal information may not have
							the same data protection laws as the country in
							which you initially provided the information. If we
					...
					<div className="mb-6">
						...
						<Text>
							You always retain the right to withhold personal
							information from us, with the understanding that
							your experience of our website may be affected. We
							will not discriminate against you for exercising any
							of your rights over your personal information. If
							you do provide us with personal information you
							understand that we will collect, hold, use and
							disclose it in accordance with this privacy policy.
							You retain the right to request details of any
						...
						<Text>
							...
							you may change your mind at any time. We will
							provide you with the ability to unsubscribe from our
							email-database or opt out of communications. Please
							be aware we may need to request specific information
					...
					<div className="mb-6">
						...
						<Text>
							...
							privacy policy, we will post the changes here at the
							same link by which you are accessing this privacy
							policy.
						</Text>
						<Text>
					...
					<div className="mb-6">
						...
						<Text>
							For any questions or concerns regarding your
							privacy, you may contact us using the following
							details:
						</Text>
						<Link
